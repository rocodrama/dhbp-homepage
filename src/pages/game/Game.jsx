...
const GAMES = [
  ...
  { key: 'dice', icon: '🎲', title: '주사위 굴리기', desc: '여러 번 굴려서 합계로 순위', Comp: DiceRoll },
  { key: 'team', icon: '🧑‍🤝‍🧑', title: '팀 나누기', desc: '랜덤으로 N팀 셔플', Comp: TeamSplit },
  { key: 'slot', icon: '🎰', title: '슬롯머신', desc: '릴 돌려서 당첨자 공개', Comp: SlotMachine },
  { key: 'race', icon: '🏇', title: '경주', desc: '끝까지 달려서 전체 순위 결정', Comp: Race },
  { key: 'survival', icon: '🏆', title: '생존게임', desc: '매 라운드 반씩 탈락, 탈락 순서로 순위', Comp: Survival },
]
